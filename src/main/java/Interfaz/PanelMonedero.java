...
public class PanelMonedero extends JPanel {
	...
	private void inicializar() {
		...
		panel_1.setBounds(39, 170, 851, 323);
		add(panel_1);
		...
		scrollPane.setBounds(29, 60, 808, 263);
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (result == JOptionPane.YES_OPTION) {
					...
					else if (Float.parseFloat(textField2.getText())<0) {
	...
	public void actualizar() {
		...
		lblBalance.setText(lblBalance.getText() + "    " + String.format("%.2f",balance));
		lblEur.setText(lblEur.getText() + "    " + String.format("%.2f",(balance * 89.54)));
		cargarLista();
